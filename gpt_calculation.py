...
DEFAULT_FILES_MAP = {
    ...
    "osm": "nigeria_major_roads.gpkg", # Application handles adding .osm extension if needed
        ...
        if osm_file is None:
            ...
            if file_name.endswith(".gpkg"):
                ...
                try:
                    ...
                    # >>> COLORBAR TRACE (LEGEND ONLY – NO GEOMETRY)
                    fig.add_trace(go.Scattermapbox(
                        lon=[map_df['geom'].iloc[0].centroid.x],
                        lat=[map_df['geom'].iloc[0].centroid.y],
                        mode="markers",
                        marker=dict(
                            size=0.01,
                            color=map_df['val'],
